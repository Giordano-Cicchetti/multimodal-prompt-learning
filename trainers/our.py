...
class QuaternionMultiModalPromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        self.qenc = QuaternionEncoder(in_channels=4,latent_dim=512)
    ...
    def forward(self, image, text_embeding):
        
        # image shape (Batch_Size, 3, 224, 224 )
        # text embedding shape (Batch_Size, 512)
        ...
        quaternion_features = quaternion_features.reshape(-1,4,512)[0]
        ...
        #print(prompts.type())
        #print(self.ctx.type())
        #print(compound_prompts_text[0].type())
